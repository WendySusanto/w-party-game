  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        {/* Header */}
        <div className="flex items-center md:justify-between w-full mb-8">
          <Button variant="ghost" onClick={leaveRoom} className="gap-2">
            <ArrowLeft className="w-4 h-4" />
            <span className="hidden md:block">Leave Room</span>
          </Button>
          <div className="text-left md:text-center ml-5 md:ml-0">
            <h1 className="text-2xl md:text-2xl font-bold mb-2">Room Lobby</h1>
